 ...
 * @usage
 * ```js
 * var Bioinformatics-Angular-App = angular.module('reallyCoolApp', ['ionic']);
 *
 * Bioinformatics-Angular-App.config(function($ionicConfigProvider) {
 ...
 * @usage
 * ```js
 * var app = angular.module('Bioinformatics-Angular-App', ['ionic'])
 ...
 *
 * ```js
 *   angular.module('Bioinformatics-Angular-App', ['ionic'])
 ...
 *
 * ```
 * angular.module('Bioinformatics-Angular-App', ['ngRoute'])`
 * ```
 *
 * becomes
 *
 * ```
 * angular.module('Bioinformatics-Angular-App', ['ngRoute', 'ngIOS9UIWebViewPatch'])
 * ```
 *
 *
 * More info:
